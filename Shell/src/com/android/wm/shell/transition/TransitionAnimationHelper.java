...
public class TransitionAnimationHelper {
    ...
    private static SurfaceControl createExtensionSurface(@NonNull SurfaceControl surfaceToExtend,
        ...
        final SurfaceControl edgeExtensionLayer = new SurfaceControl.Builder()
                ...
                .setHidden(true)
                .setSecure(edgeBuffer.containsSecureLayers())
        ...
        //@ M: fix for GPU violation start @{
        final boolean isProtectedContent = (edgeBuffer.getHardwareBuffer().getUsage() &
                HardwareBuffer.USAGE_PROTECTED_CONTENT) == HardwareBuffer.USAGE_PROTECTED_CONTENT;
        if (isProtectedContent) {
            Log.w("TransitionAnimationHelper", "use TRANSPARENT to edge layer: " +
                    surfaceToExtend);
