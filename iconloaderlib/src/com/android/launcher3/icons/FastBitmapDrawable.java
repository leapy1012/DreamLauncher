...
public class FastBitmapDrawable extends Drawable implements Drawable.Callback {
    ...
    public int getIconColor() {
        int whiteScrim = GraphicsUtils.setColorAlphaBound(Color.WHITE, WHITE_SCRIM_ALPHA);
    ...
    public static FastBitmapDrawable newIcon(Context context, BitmapInfo info) {
        ...
        drawable.mDisabledAlpha = getDefaultDisabledIconAlpha(context);
        return drawable;
    }

    public static float getDefaultDisabledIconAlpha(Context context) {
        return GraphicsUtils.getFloat(context, R.attr.disabledIconAlpha, 1.0f);
    }
