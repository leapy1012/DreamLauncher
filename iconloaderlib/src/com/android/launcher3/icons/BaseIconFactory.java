...
public class BaseIconFactory implements AutoCloseable {
    ...
    public BitmapInfo createBadgedIconBitmap(@NonNull Drawable icon,
        ...
        return createBadgedIconBitmap(icon, options, mWrapperBackgroundColor);
    }

    @NonNull
    public BitmapInfo createBadgedIconBitmap(@NonNull Drawable icon,
            @Nullable IconOptions options, int wrapperBackgroundColor) {
        boolean shrinkNonAdaptiveIcons = options == null || options.mShrinkNonAdaptiveIcons;
        float[] scale = new float[1];
        icon = normalizeAndWrapToAdaptiveIcon(icon, shrinkNonAdaptiveIcons, null, scale, wrapperBackgroundColor);
    ...
    protected Drawable normalizeAndWrapToAdaptiveIcon(@Nullable Drawable icon,
            ...
            @NonNull final float[] outScale, int wrapperBackgroundColor) {
        if (icon == null) {
            return null;
        }
        float scale = 1f;
    ...
    protected Drawable normalizeAndWrapToAdaptiveIcon(@Nullable Drawable icon,
        ...
        return normalizeAndWrapToAdaptiveIcon(icon, shrinkNonAdaptiveIcons, outIconBounds, outScale,
