...
public class OverlayViewLifecycleOwnerImpl implements ViewLifecycleOwner {
    ...
    private final Runnable mUpdateStateRunnable = new Runnable() {
        @Override
        public void run() {
    ...
    public OverlayViewLifecycleOwnerImpl(View view, ViewModelProvider.Factory factory) {
        mView = view;
    ...
    private void updateState() {
        mView.removeCallbacks(mUpdateStateRunnable);
        mView.postDelayed(mUpdateStateRunnable, 500);
    }
