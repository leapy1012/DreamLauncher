...
public class COUIListPreference extends ListPreference implements COUICardSupportInterface, COUIRecyclerView.ICOUIDividerDecorationInterface {
    ...
    public COUIListPreference(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public COUIListPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, R.style.Preference_COUI_COUIWithPopupIcon);
    }

    public COUIListPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs);
    ...
    public void setJump(int resId) {
        setJump(getContext().getResources().getDrawable(resId));
    }
