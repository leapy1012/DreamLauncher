...
public class DeformedValueBean {
    ...
    public float getWidthDeformedValue() {
        return mWidthDeformedValue;
    }

    public void setDrawProgressScale(float value) {
        mDrawProgressScale = value;
    }

    public void setHeightBottomDeformedDownValue(float value) {
        mHeightBottomDeformedDownValue = value;
    }

    public void setHeightBottomDeformedUpValue(float value) {
        mHeightBottomDeformedUpValue = value;
    }

    public void setHeightTopDeformedDownValue(float value) {
        mHeightTopDeformedDownValue = value;
    }

    public void setHeightTopDeformedUpValue(float value) {
        mHeightTopDeformedUpValue = value;
    }
    ...
    public void setWidthDeformedValue(float value) {
        mWidthDeformedValue = value;
    }
}
