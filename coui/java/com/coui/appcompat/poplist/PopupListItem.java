...
public class PopupListItem {
    ...
    public static class Builder {
        ...
        public Builder setDescriptionContentDescription(String description) {
            mDescriptionContentDescription = description;
            return this;
        }

        public Builder setForceTint(int forceTint) {
        ...
        @Deprecated
        public Builder setHasSubArray(boolean hasSubArray) {
            return this;
        }

        public Builder setHintType(int hintType) {
            mHintType = hintType;
            return this;
        }
        ...
        @Deprecated
        public Builder setIsCheckable(boolean isCheckable) {
            return this;
        }
        ...
        @Deprecated
        public Builder setIsClickSubArray(boolean isClickSubArray) {
            return this;
        }
        ...
        @Deprecated
        public Builder setItemColorSpecial(int itemColorSpecial) {
            return this;
        }
        ...
        @Deprecated
        public Builder setOperateIcon(Drawable icon) {
            mStateIcon = icon;
            return this;
        }

        public Builder setRedDotAmount(int amount) {
            mRedDotAmount = amount;
            return this;
        }

        public Builder setRedDotText(String text) {
            mRedDotText = text;
            return this;
        }

        public Builder setStateIcon(Drawable icon) {
            mStateIcon = icon;
            return this;
        }

        public Builder setStateIconId(int stateIconId) {
            mStateIconId = stateIconId;
            return this;
        }

        @Deprecated
        public Builder setSubArray(ArrayList<PopupListItem> items) {
            mSubMenuItemList = items;
            return this;
        }

        public Builder setSubMenuItemList(ArrayList<PopupListItem> items) {
            mSubMenuItemList = items;
            return this;
        }
        ...
        @Deprecated
        public Builder setTitleColorInt(int color) {
            return this;
        }

        public Builder setTitleColorList(ColorStateList color) {
            mTitleColor = color;
            return this;
        }

        public Builder setTitleContentDescription(String description) {
    ...
    public View getCustomHintView() {
        return mCustomHintView;
    }

    public View getCustomItemView() {
        return mCustomItemView;
    }
    ...
    public String getDescriptionContentDescription() {
        return mDescriptionContentDescription;
    }
    ...
    public String getTitleContentDescription() {
        return mTitleContentDescription;
    }
    ...
    public boolean hasSubMenu() {
        return mSubMenuItemList != null && !mSubMenuItemList.isEmpty();
    }
    ...
    public void setDescriptionContentDescription(String description) {
        mTitleContentDescription = description;
    }
    ...
    public void setForceTint(int forceTint) {
        mForceTint = forceTint;
    }
    ...
    @Deprecated
    public void setHasSubArray(boolean hasSubArray) {
    }
    ...
    @Deprecated
    public void setItemColorSpecial(int color) {
    }
    ...
    @Deprecated
    public void setOperateIcon(Drawable icon) {
        mStateIcon = icon;
    }

    public void setRedDotAmount(int amount) {
        mRedDotAmount = amount;
    }
    ...
    public void setStateIconId(int stateIconId) {
        mStateIconId = stateIconId;
    }

    @Deprecated
    public void setSubArray(ArrayList<PopupListItem> items) {
        mSubMenuItemList = items;
    }

    public void setSubMenuItemList(ArrayList<PopupListItem> items) {
        mSubMenuItemList = items;
    }
    ...
    @Deprecated
    public void setTitleColorInt(int color) {
    }

    public void setTitleColorList(ColorStateList color) {
        mTitleColor = color;
    }

    public void setTitleContentDescription(String description) {
        mTitleContentDescription = description;
    }

    @Deprecated
    public PopupListItem(String title, boolean enable) {
        this((Drawable) null, title, enable);
    }

    @Deprecated
    public PopupListItem(int iconId, String title, boolean enable) {
        this();
        mIconId = iconId;
        mTitle = title;
        mIsEnable = enable;
    ...
    @Deprecated
    public PopupListItem(String title, boolean enable, int groupId) {
        this((Drawable) null, title, enable);
        mGroupId = groupId;
    }

    @Deprecated
    public PopupListItem(Drawable icon, String title, boolean enable) {
        this(icon, title, enable, -1);
    }

    @Deprecated
    public PopupListItem(Drawable icon, String title, boolean enable, int redDotAmount) {
        this(icon, title, false, false, redDotAmount, enable);
    }

    @Deprecated
    public PopupListItem(Drawable icon, String title, boolean checked, boolean hasSub) {
        this(icon, title, checked, false, hasSub);
    }

    @Deprecated
    public PopupListItem(Drawable icon, String title, boolean checked, boolean sub, boolean enable) {
        this(icon, title, checked, sub, -1, enable);
    }

    @Deprecated
    public PopupListItem(Drawable icon, String title, boolean checked, boolean sub,
