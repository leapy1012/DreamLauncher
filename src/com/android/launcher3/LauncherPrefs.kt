...
class LauncherPrefs(private val encryptedContext: Context) {
    ...
    companion object {
        ...
        // 卸载应用后自动对齐网格
        const val WORKSPACE_FILL_CELL = "pref_fill_cell"
        // 一键清理
        const val WORKSPACE_MEMORY_CLEAN = "pref_memory_clean"
        // 壁纸设置
        const val WORKSPACE_WALLPAPER_SET = "pref_wallpaper_set"
        // 布局锁定
        ...
        // 图标大小
        const val WORKSPACE_ICON_SIZE = "pref_icon_size"
        // 显示文本大小
        const val WORKSPACE_TEXT_SIZE = "pref_text_size"
        // 双击息屏
        const val WORKSPACE_DOUBLE_TAP = "pref_double_tap"
        // 新安装应用显示小圆点
        const val WORKSPACE_INSTALL_BEHAVIOR = "pref_install_behavior"
        // 负一屏
        const val WORKSPACE_MINUS = "pref_minusEnabled"
        // 右一屏
        const val WORKSPACE_PLUS = "pref_plusEnabled"
        ...
        @JvmField val KEY_THEMED = backedUpItem(Themes.KEY_THEMED, false, true)//hxy-feature: desktop theme 202312
        @JvmField val WORKSPACE_SCROLL_EFFECT = backedUpItem("launcher_workspace_scroll_effect", "")
