...
public class ShortcutUtil {
    ...
    public static boolean supportsWorkspaceShortcuts(ItemInfo info) {
        return isActive(info) && isApp(info) && LauncherPrefs.getPrefs(LauncherApplication.getContext()).getBoolean(LauncherPrefs.WORKSPACE_INSTALL_BEHAVIOR, false);
    }
