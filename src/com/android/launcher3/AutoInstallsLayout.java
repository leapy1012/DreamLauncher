...
public class AutoInstallsLayout {
    ...
    protected class FolderParser implements TagParser {
        ...
        public int parseAndAdd(XmlPullParser parser) throws XmlPullParserException, IOException {
            ...
            try {
                mValues.put("spanX", Integer.valueOf(Math.max(Integer.parseInt(getAttributeValue(parser, "spanX")), 1)));
                mValues.put("spanY", Integer.valueOf(Math.max(Integer.parseInt(getAttributeValue(parser, "spanY")), 1)));
            } catch (Exception e) {
                mValues.put("spanX", 1);
                mValues.put("spanY", 1);
            }
