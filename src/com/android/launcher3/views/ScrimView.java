...
//frameworks/libs/systemui/iconloaderlib/src/com/android/launcher3/icons/GraphicsUtils.java
...
public class ScrimView extends View implements Insettable {
    ...
    // All apps bg transparent need change text color same with workspace start
    private static final int ALLAPP_BG_COLOR = 0xFF000000;
    ...
    public ScrimView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // All apps bg transparent need change text color same with workspace start
        mEndFlatColorAlpha = context.getResources().getInteger(R.integer.allapps_bg_alpha);
        // All apps bg transparent need change text color same with workspace end
        setFocusable(false);
    }
