...
public class InvariantDeviceProfile {
    ...
    public boolean showHotseatText;
    public boolean showDoubleLines;
    ...
    public static String getCurrentGridName(Context context) {
        //added by zhushuangqian for grid start
        String gridName = LauncherPrefs.get(context).get(GRID_NAME);
        if( gridName == null && context.getResources().getBoolean(R.bool.config_hxy_grid)){
            gridName = context.getResources().getString(R.string.config_default_grid);
        }
        return gridName;
        //added by zhushuangqian for grid start
    ...
    private Object[] toModelState() {
        return new Object[]{
                numColumns, numRows, numSearchContainerColumns, numDatabaseHotseatIcons, showHotseatText, showDoubleLines,
    ...
    private static ArrayList<DisplayOption> getPredefinedDeviceProfiles(Context context,
        ...
        int resDeviceProfiles = R.xml.device_profiles;
        if(context.getResources().getBoolean(R.bool.config_hxy_grid)){
            resDeviceProfiles = R.xml.hxy_device_profiles;
        }
        try (XmlResourceParser parser = context.getResources().getXml(resDeviceProfiles)) {
