...
public class LauncherPopupLiveUpdateHandler extends PopupLiveUpdateHandler<Launcher> {
    ...
    public void onWidgetsBound() {
        ...
        SystemShortcut widgetInfo = (originalIcon != null && originalIcon.getTag() != null)? SystemShortcut.WIDGETS.getShortcut(mContext,
        (ItemInfo) originalIcon.getTag(), originalIcon) : null;
