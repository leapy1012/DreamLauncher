...
import static com.android.launcher3.LauncherPrefs.KEY_THEMED;
//hxy-feature: desktop theme 202312
...
public class GridCustomizationsProvider extends ContentProvider {
    ...
    //hxy-feature: desktop theme 202312
    private static final String SET_THEMED = "/set_theme";
    private static final String GET_THEMED = "/get_theme";
    private static final String THEME_VALUE = "theme_value";
    //hxy-feature: desktop theme 202312
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uri.getPath()) {
            ...
            //hxy-feature: desktop theme 202312
            case GET_THEMED:{
                MatrixCursor cursor = new MatrixCursor(new String[] {THEME_VALUE});
                cursor.newRow().add(THEME_VALUE, isThemedIconEnabled(getContext()) ? 1 : 0);
                return cursor; 
            }
            //hxy-feature: desktop theme 202312
            default:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        switch (uri.getPath()) {
            ...
            case SET_THEMED: {
                LauncherPrefs.get(getContext())
                        .put(KEY_THEMED, values.getAsString(THEME_VALUE));
                return 1;
            }
             //hxy-feature: desktop theme 202312
            default:
