...
public class LauncherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        android.util.Log.d("liu-db", "delete 199 delete" + selection);
        SqlArguments args;
        if (!TextUtils.isEmpty(selection)) {
            args = new SqlArguments(uri, selection);
        } else {
            args = new SqlArguments(uri, selection, selectionArgs);
        }
    ...
    static class SqlArguments {
        ...
        //add by HXY:for widget bug start
        SqlArguments(Uri url, String where) {
