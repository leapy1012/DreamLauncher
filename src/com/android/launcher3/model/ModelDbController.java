...
import static com.android.launcher3.DefaultLayoutParser.RES_PARTNER_DEFAULT_LAYOUT_ALL;
...
public class ModelDbController {
    ...
    public int delete(String table, String selection, String[] selectionArgs) {
        if (!mContext.getSystemService(android.os.UserManager.class).isUserUnlocked()) {
            return -1;
        }
        createDbIfNotExists();
        SQLiteDatabase db = mOpenHelper.getWritableDatabase();
    ...
    public synchronized void loadDefaultFavoritesIfNecessary() {
        ...
        if (LauncherPrefs.get(mContext).get(getEmptyDbCreatedKey(mOpenHelper.getDatabaseName()))) {
            ...
            try {
                ...
                if (loader == null && !mContext.getResources().getBoolean(R.bool.config_hxy_grid)) {
